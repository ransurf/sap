...
const Drawer = (props: Props) => {
  ...
  return (
    <div className="drawer max-w-xs">
	  ...
	  <div>
	  	<iframe src="https://calendar.google.com/calendar/embed?height=600&wkst=1&bgcolor=%23ffffff&ctz=America%2FVancouver&showNav=0&showTitle=0&showPrint=0&showTabs=0&showCalendars=0&src=c2F0LmdhcmcwM0BnbWFpbC5jb20&color=%23039BE5" width="300" height="600"  scrolling="no"></iframe>
	  </div>
    </div>
  );
};
